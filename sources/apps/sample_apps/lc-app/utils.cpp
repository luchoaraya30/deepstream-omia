...
map<int, vector<int>> m_1_10;
map<int, vector<int>> m_11_18;
map<int, vector<int>> m_19_35;
map<int, vector<int>> m_36_50;
map<int, vector<int>> m_51_64;
map<int, vector<int>> m_gte_65;

map<int, vector<int>> f_1_10;
map<int, vector<int>> f_11_18;
map<int, vector<int>> f_19_35;
map<int, vector<int>> f_36_50;
map<int, vector<int>> f_51_64;
map<int, vector<int>> f_gte_65;
...
void createCounters ()
{
  ...
  for (int camera_id : this_cameras_id) {
    ...
    if (this_sgie_gender != 0 || this_sgie_age != 0) {
      ...
      m_1_10.insert(pair<int, vector<int>>(camera_id, temp));
      m_11_18.insert(pair<int, vector<int>>(camera_id, temp));
      m_19_35.insert(pair<int, vector<int>>(camera_id, temp));
      m_36_50.insert(pair<int, vector<int>>(camera_id, temp));
      m_51_64.insert(pair<int, vector<int>>(camera_id, temp));
      m_gte_65.insert(pair<int, vector<int>>(camera_id, temp));
      
      count_females.insert(pair<int, vector<int>>(camera_id, temp));
      f_1_10.insert(pair<int, vector<int>>(camera_id, temp));
      f_11_18.insert(pair<int, vector<int>>(camera_id, temp));
      f_19_35.insert(pair<int, vector<int>>(camera_id, temp));
      f_36_50.insert(pair<int, vector<int>>(camera_id, temp));
      f_51_64.insert(pair<int, vector<int>>(camera_id, temp));
      f_gte_65.insert(pair<int, vector<int>>(camera_id, temp));
    }
  }
}
  ...
  if (is_male[stream_id]) {
    ...
    switch (class_id) {
      ...
      case 2:
        ...
        break;
      case 3:
        f_36_50[camera_id][lc_id]++;
        //cout << name_lc_person[cam_id][lc] << " count age 36_50: " << age_3_count[cam_id][lc]++;
        break;
      case 4:
        f_51_64[camera_id][lc_id]++;
        //cout << name_lc_person[cam_id][lc] << " count age 51_64: " << age_4_count[cam_id][lc]++;
        break;
      case 5:
        f_gte_65[camera_id][lc_id]++;
        //cout << name_lc_person[cam_id][lc] << " count age gte_65: " << age_5_count[cam_id][lc]++;
        break;
      default:
        break;
...
void updateLCCount (int camera_id, NvDsAnalyticsFrameMeta *analytics_frame_meta, NvDsEventMsgMeta *lc_data)
{
  ...
  if (this_sgie_gender != 0 || this_sgie_age != 0) {
    for (int i = 0; i < (int) this_sgie_names[camera_id].size(); i++) {
      ...
      lc_data->m_1_10[i] = m_1_10[camera_id][i];
      lc_data->m_11_18[i] = m_11_18[camera_id][i];
      lc_data->m_19_35[i] = m_19_35[camera_id][i];
      lc_data->m_36_50[i] = m_36_50[camera_id][i];
      lc_data->m_51_64[i] = m_51_64[camera_id][i];
      lc_data->m_gte_65[i] = m_gte_65[camera_id][i];
      
      lc_data->count_females[i] = count_females[camera_id][i];
      lc_data->f_1_10[i]= f_1_10[camera_id][i];
      lc_data->f_11_18[i] = f_11_18[camera_id][i];
      lc_data->f_19_35[i] = f_19_35[camera_id][i];
      lc_data->f_36_50[i] = f_36_50[camera_id][i];
      lc_data->f_51_64[i] = f_51_64[camera_id][i];
